...
import { Content, ContentWrap, FakeCard, Header, Img, SearchGroup, Section, StyledButton, StyledCard, StyledInput, Title, UserName } from './style';
    ...
    <Section>
      {boards.map((board, i) =>
        <StyledCard key={i} onClick={onClickCard(board.boardId)}>
          <Img src={deleteImg} onClick={onClickDelete(board.boardId)} />
